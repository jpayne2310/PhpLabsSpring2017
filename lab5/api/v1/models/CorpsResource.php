...
class CorpsResource extends DBSpring implements IRestModel {
    ...
    public function post($serverData) {
        ...
        $stmt = $this->getDb()->prepare("INSERT INTO corps SET corp = :corp, "
                . "incorp_dt = :incorp_dt, email = :email, owner = :owner, "
    ...
    public function put($serverData, $id) {
        $stmt = $this->getDb()->prepare("UPDATE corps SET corp = :corp, "
                . "incorp_dt = :incorp_dt, email = :email, owner = :owner, "
                . "phone = :phone, location = :location WHERE id = :id");
        $binds = array(
            ":id" => $id,
            ":corp" => $serverData['corp'],
            ":incorp_dt" => $serverData['incorp_dt'],
