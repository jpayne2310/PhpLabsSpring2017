(function () {
    ...
    function CorpService($http, REQUEST) {
         ...
         * 
         * The frist then function will be for our sucess call, which then we 
         ...
         * 
         * So we return the promise, which in turn when the promise is 
         * complete will return a response for us to use.
         */
